...
public class IPToCIDR {
    public List<String> getCIDR(String startIP, String endIP){
        ...
        while(start<=end){
          ...
          result.add(longToIPString(start)+"/"+mask);
          //shift start 
      ...
      // if startIP end with binary 1, return 32; range 1
      // if startIP end with binary 10, return 31; range 2. 
      // if startIP end with binary 100, return 30; range is 4
      ...
      // int has sign, 0 start is postive, 1 start is negtive. so it's better to use long here. 
      ...
      private static String longToIPString(long longIP) {         
          StringBuffer sb = new StringBuffer("");         
          sb.append(String.valueOf(longIP >> 24));         
          sb.append(".");         
          sb.append(String.valueOf((longIP & 0x00FF0000) >> 16));         
          sb.append(".");         
          sb.append(String.valueOf((longIP & 0x0000FF00) >> 8));         
          sb.append(".");         
